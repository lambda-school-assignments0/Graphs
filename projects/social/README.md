...
We would need to call `add_friendship()` 500 times if we're counting a friendship between `A -> B` and `B -> A` as two friendships.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

The average degree of separation between a user and those in his/her network is `4`.
...
This should imitate real life pretty closely. We could make it so that there are more clusters of friendships.
